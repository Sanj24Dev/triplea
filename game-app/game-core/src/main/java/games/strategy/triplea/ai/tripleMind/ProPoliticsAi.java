...
import games.strategy.triplea.ai.tripleMind.data.ProTerritoryManager;
...
import games.strategy.triplea.ai.tripleMind.util.ProUtils;
...
class ProPoliticsAi {
  ...
  ProPoliticsAi(final AbstractTripleMindAi ai) {
    calc = ai.getCalc();
