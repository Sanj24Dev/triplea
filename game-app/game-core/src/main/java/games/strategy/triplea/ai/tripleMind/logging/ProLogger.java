package games.strategy.triplea.ai.tripleMind.logging;

import games.strategy.triplea.ai.tripleMind.AbstractTripleMindAi;
import games.strategy.triplea.ai.tripleMind.ProCombatMoveAi;
...
public final class ProLogger {
   ...
   * message indentation. For example, the base logs in the {@link AbstractTripleMindAi} class have no
   * indentation before them, but the base logs in the {@link
   * ProCombatMoveAi} class will have two spaces inserted at the
