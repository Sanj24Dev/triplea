...
import games.strategy.triplea.ai.tripleMind.data.ProBattleResult;
import games.strategy.triplea.ai.tripleMind.logging.ProLogger;
import games.strategy.triplea.ai.tripleMind.util.ProBattleUtils;
import games.strategy.triplea.ai.tripleMind.util.ProMatches;
import games.strategy.triplea.ai.tripleMind.util.ProOddsCalculator;
import games.strategy.triplea.ai.tripleMind.util.ProSortMoveOptionsUtils;
...
class ProScrambleAi {
  ...
  ProScrambleAi(final AbstractTripleMindAi ai) {
    calc = ai.getCalc();
